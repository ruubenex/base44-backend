...
import { Sparkles, Dumbbell, ChefHat, TrendingUp, Brain, Scale, Calendar, ShoppingCart } from 'lucide-react';

const aiFeatures = [
  {
    icon: Dumbbell,
    title: "Plano de Exercícios",
    description: "Treinos personalizados baseados no seu objetivo, nível de condicionamento e disponibilidade."
  },
  {
    icon: ChefHat,
    title: "Receitas Personalizadas",
    description: "Receitas deliciosas com passo a passo e todos os ingredientes medidos para suas metas."
  },
  {
    icon: ShoppingCart,
    title: "Lista de Mercado",
    description: "Sugestões de compras inteligentes baseadas nas suas receitas semanais."
  },
  {
    icon: TrendingUp,
    title: "Acompanhamento de IMC",
    description: "Monitore sua evolução de peso e IMC com gráficos detalhados."
  },
];
    ...
    <section ref={sectionRef} className={`py-24 md:py-32 relative overflow-hidden transition-colors duration-1000 ${isDarkMode ? 'bg-[#0A0A0A]' : 'bg-white'}`}>
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            backgroundImage: `radial-gradient(circle at 2px 2px, ${isDarkMode ? '#f97316' : '#fdba74'} 1px, transparent 0)`,
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <motion.div
              ...
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 ${isDarkMode ? 'bg-gradient-to-r from-orange-500/20 to-purple-500/20 border border-orange-500/30' : 'bg-gradient-to-r from-orange-100 to-purple-100 border border-orange-200'}`}
            >
            ...
            <p className={`text-lg mb-8 leading-relaxed ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              Informe seu peso atual, meta de peso, altura, idade, gênero e em quanto tempo quer atingir seu objetivo. 
              Nossa IA cria um plano completo e exclusivo pra você. 🚀
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {aiFeatures.map((feature, index) => (
                <motion.div
                  ...
                  className={`flex items-start gap-3 p-4 rounded-2xl transition-all duration-300 hover:scale-105 ${isDarkMode ? 'bg-white/5 hover:bg-white/10' : 'bg-gray-50 hover:bg-orange-50'}`}
                >
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${isDarkMode ? 'bg-orange-500/20' : 'bg-orange-100'}`}>
                    <feature.icon className={`w-5 h-5 ${isDarkMode ? 'text-orange-400' : 'text-orange-500'}`} />
                  </div>
                  <div>
            ...
            <div className="relative mx-auto max-w-[260px] sm:max-w-xs">
              ...
              <div className="relative bg-black rounded-[2rem] md:rounded-[2.5rem] p-1.5 md:p-2 shadow-2xl">
                <div className="bg-white rounded-[1.5rem] md:rounded-[2rem] overflow-hidden">
                  <img 
                    src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/user_69838e5237519a0f64a3cf05/12995b60c_IMG_8534.png"
                    alt="CamCal AI Personalized Routine"
              ...
              <div className={`absolute -top-2 -right-2 md:-top-4 md:-right-4 px-3 py-2 md:px-4 md:py-3 rounded-xl md:rounded-2xl shadow-lg animate-bounce ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`} style={{ animationDuration: '3s' }}>
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-sm md:text-base font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>IA Ativa</span>
                </div>
              </div>
              ...
              <div className={`absolute -bottom-2 -left-2 md:-bottom-4 md:-left-4 px-3 py-2 md:px-4 md:py-3 rounded-xl md:rounded-2xl shadow-lg animate-bounce ${isDarkMode ? 'bg-gradient-to-r from-orange-600 to-red-600' : 'bg-gradient-to-r from-orange-500 to-red-500'}`} style={{ animationDuration: '3.5s', animationDelay: '0.5s' }}>
                <div className="flex items-center gap-2 text-white">
                  ...
                  <span className="text-sm md:text-base font-semibold">Plano de 40 dias</span>
                </div>
              </div>
            </div>
          </motion.div>
