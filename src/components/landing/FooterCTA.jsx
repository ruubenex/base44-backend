    ...
    <section ref={sectionRef} className={`py-24 md:py-32 relative overflow-hidden transition-colors duration-1000 ${isDarkMode ? 'bg-[#0A0A0A]' : 'bg-gradient-to-b from-white to-orange-50'}`}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div
          ...
          className={`relative rounded-[3rem] p-8 md:p-16 overflow-hidden ${
            isDarkMode 
              ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-white/10' 
              : 'bg-gradient-to-br from-white via-orange-50 to-white border border-orange-100'
          } shadow-2xl`}
        >
          ...
          <div className="text-center relative z-10">
            ...
            <div className="mb-6 md:mb-8">
              <img 
                ...
                alt="CamCal Logo"
                className={`h-16 md:h-20 lg:h-24 mx-auto ${isDarkMode ? '' : 'drop-shadow-lg'}`}
                loading="lazy"
              />
            </div>
            ...
            <p className={`text-lg md:text-xl mb-10 max-w-2xl mx-auto ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              Comece agora sua jornada rumo ao corpo e saúde que você sempre quis. 
            ...
            >
              <a href="https://camcal.pro/" target="_blank" rel="noopener noreferrer">
                <Button 
                  size="lg"
                  className="group bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-10 py-7 text-xl rounded-2xl shadow-xl shadow-orange-500/30 hover:shadow-2xl hover:shadow-orange-500/50 transition-all duration-300 hover:scale-105"
                >
            ...
            >
              ...
              <div className={`flex items-center gap-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                ...
                <span className="text-sm">50k+ usuários satisfeitos</span>
              </div>
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className={`mt-16 text-center ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}
        >
          ...
          <p className="text-sm mb-4">
            Transformando vidas através da tecnologia e nutrição inteligente.
          </p>
          <div className="flex items-center justify-center gap-4">
            <a 
              href="https://camcal.pro/" 
              target="_blank" 
              rel="noopener noreferrer"
              className={`text-sm hover:text-orange-500 transition-colors ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}
            >
              Acessar App
            </a>
            <span>•</span>
          ...
          <p className="text-xs mt-8">
            © 2024 CamCal. Todos os direitos reservados.
          </p>
        </motion.div>
      </div>
    </section>
